...
import com.heejae.springboot.domain.user.Role;
...
// authorizeRequests : URL 별 권한 관리를 설정하는 옵션의 시작점이다. authorizeRequests 가 선언되어야만 andMatchers 옵션을 사용할 수 있다.
...
// anyRequest : 설정된 값들 이외 나머지 URL 들을 나타낸다. 여기서는 authenticated() 를 추가하여 나머지 URL 들은 모두 인증된 사용자들에게만 허용하게 한다.
